...
error5 = document.getElementById("error5").innerHTML ="";



if ( username == ""  || email == "" || locate == "" || description == "" ){  
  ...
  document.getElementById("error3").innerHTML = "Please enter a valid email.";
    ...
    document.getElementById("error4").innerHTML = "Please select a problem's location.";
        valid = false;
} 

else if (description.length < 50){
  document.getElementById("error5").innerHTML ="Please fill out this the description field (50 characters minumum)";
  valid = false;
} 
